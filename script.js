    ...
    for (let n = 0; n < predictions.length; n++) {
      ...
      if (predictions[n].score > 0.85) {
        const p = document.createElement('p');
			...
			document.getElementById("aiDemo").innerText = predictions[n].class  + ' - with ' 
            + Math.round(parseFloat(predictions[n].score) * 100) 
            + '% Accuracy.';
			
			document.getElementById("myVideo").src = "videos/video2.mp4";
			
			document.getElementById("vidColor").innerHTML = "black";
			document.getElementById("vidMake").innerHTML = "Not applicable";
			document.getElementById("vidModel").innerHTML = "Not Applicable";
            ...
            + '% Accuracy.';
				...
				document.getElementById("myVideo").src = "videos/video3.mp4";
				
				document.getElementById("vidColor").innerHTML = "White";
				document.getElementById("vidMake").innerHTML = "Mitsubishi";
				document.getElementById("vidModel").innerHTML = "Fuso";
            ...
            + '% Accuracy.';
				...
				document.getElementById("myVideo").src = "videos/video4.mp4";
				
				document.getElementById("vidColor").innerHTML = "Red"
				document.getElementById("vidMake").innerHTML = "Toyota";
				document.getElementById("vidModel").innerHTML = "Rav4";
            ...
            + '% Accuracy.';
				...
				document.getElementById("vidColor").innerHTML = "Blue";
				document.getElementById("vidMake").innerHTML = "Mitsubishi";
				document.getElementById("vidModel").innerHTML = "Rosa";
